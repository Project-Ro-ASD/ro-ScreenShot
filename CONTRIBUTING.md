...
3. **Tests:** All core changes must include unit tests in `tests/` and pass with 100% green via `QT_QPA_PLATFORM=offscreen ctest --test-dir build-local --output-on-failure`.
